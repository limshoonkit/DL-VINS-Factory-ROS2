...
// loop_fusion is built 4-DoF (x, y, z, yaw) only. Assume use imu
...
private:
	...
	// Loop-fusion metrics.
	double last_top1_sim_ = -1.0;
	uosm::loop_fusion::LoopMetricsLogger &metrics_logger_ =
		uosm::loop_fusion::LoopMetricsLogger::getInstance();
...
public:
	...
	{
		return new ceres::AutoDiffManifold<AngleLocalManifold, 1, 1>;
	}
};
...
// RelativeRTError (6DoF residual) intentionally removed
// with IMU -> 4DoF.