...
def _make_launch(context, *args, **kwargs):
    ...
    config_yaml = os.path.join(pkg_share, "config", "ntu_viral", f"stereo_{extractor}.yaml")
    ...
    # NTU VIRAL convention: cam0 = right (camRight.yaml / /right/image_raw),
    #                       cam1 = left  (camLeft.yaml  / /left/image_raw).
    composable_nodes = [
        ComposableNode(
            package="dl_vins",
