...
def _make_launch(context, *args, **kwargs):
    ...
    config_yaml = os.path.join(pkg_share, "config", "euroc", f"stereo_{extractor}.yaml")
    ...
    # use_sim_time → component clock follows /clock published by `ros2 bag play --clock`.
    ...
    if use_viz:
        # dl_vins_component broadcasts odom->body and body->cam* TFs. Publish an
