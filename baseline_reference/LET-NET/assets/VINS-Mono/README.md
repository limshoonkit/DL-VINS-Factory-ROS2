...
> Note: The VINS is sensitive to corners selected.

> This code is just used to run in UMA-VI datasets. It's just a demo for application of LET-NET. 

## 1. Prerequisites
- VINS-Mono 
- LET-NET 

## 2. Download UMA-VI datasets 
...
## 4. Run Demo as in VINS 

1. In terminal 1, run `roslaunch vins_estimator uma_vi.launch`
2. In terminal 2, run `roslaunch vins_estimator vins_rviz.launch`
3. In terminal 3, run `./devel/lib/feature_tracker/feature_tracker_illustration`
