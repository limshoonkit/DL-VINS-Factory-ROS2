...
void FeatureTracker::let_init(){
    ...
    const char* env_md = std::getenv("LET_NET_MODEL_DIR");
    std::string md = env_md ? std::string(env_md) : std::string("/root/catkin_ws/src/VINS-Mono/model");
    net.load_param((md + "/model.param").c_str());
    net.load_model((md + "/model.bin").c_str());
}
